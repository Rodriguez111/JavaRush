...
public class StrikeThroughAction extends StyledEditorKit.StyledTextAction {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (editor != null) {
            ...
            StyleConstants.setStrikeThrough(simpleAttributeSet, !StyleConstants.isStrikeThrough(mutableAttributeSet));//устанавливаем новому атрибуту значение подчеркивания тру или фолс, смотря на то есть ли оно
