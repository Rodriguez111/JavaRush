...
public class SubscriptAction extends StyledEditorKit.StyledTextAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (editor != null) {
            ...
            StyleConstants.setSubscript(simpleAttributeSet, !StyleConstants.isSubscript(mutableAttributeSet));//устанавливаем новому атрибуту значение подчеркивания тру или фолс, смотря на то есть ли оно
