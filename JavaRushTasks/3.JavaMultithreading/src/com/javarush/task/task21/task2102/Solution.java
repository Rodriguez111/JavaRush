...
/*Решение: сравнив (allModifiers & specificModifier) != 0; узнаем, если не равно 0,
 то модификатор в наборе байт есть!
     */
            if((allModifiers & specificModifier)!=0){return true;}//решение
