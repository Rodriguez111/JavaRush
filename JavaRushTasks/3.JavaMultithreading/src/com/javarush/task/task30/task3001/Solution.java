...
public class Solution {
    public static void main(String[] args) {
        Number number;
        Number result;
         number = new Number(NumerationSystemType._10, "6");
    ...
    public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) throws NumberFormatException {
        ...
        String resultNumber = bigInteger.toString(expectedNumerationSystem.getNumerationSystemIntValue());

        return new Number(expectedNumerationSystem, resultNumber);
