...
public class BankAccount {
    ...
    public synchronized void withdraw(BigDecimal money) throws NotEnoughMoneyException {
        ...
        balance = newBalance;
        System.out.println("Тратим " + money + ", на счету " + balance+" ("+Thread.currentThread().getName()+")");
    }
    ...
    public synchronized void withdraw(String money) throws NotEnoughMoneyException { //делегирование
