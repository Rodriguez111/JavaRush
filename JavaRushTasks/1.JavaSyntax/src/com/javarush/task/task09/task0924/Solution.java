...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        wolf.ate.add(grandmother); //добавление объектов в массив
        wolf.ate.add(hood); //добавление объектов в массив
        woodman.killed.add(wolf); //добавление объектов в массив
    }
